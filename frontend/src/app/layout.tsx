...
export const metadata: Metadata = {
  ...
  description: 'WIS diseña agentes de IA, workflows e integraciones para que empresas de Argentina y LATAM vendan mejor, ahorren tiempo y operen con menos fricción.',
